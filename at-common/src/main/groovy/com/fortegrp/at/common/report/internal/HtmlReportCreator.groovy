...
import com.fortegrp.at.extension.GlobalSpecExtension
...
class HtmlReportCreator extends AbstractHtmlCreator<SpecData> {
    ...
    void createReportFor(SpecData data) {
        def specClassName = data.info.description.className + CommonEnvironment.reportGlobalSuffix()
    ...
    protected String reportHeader(SpecData data) {
        "Report for ${data.info.description.className + CommonEnvironment.reportGlobalSuffix()}"
    }
            ...
            table('class': 'summary-table') {
                ...
                tbody {
                    tr {
                        ...
                        reportAggregator?.aggregateReport(data.info.description.className + CommonEnvironment.reportGlobalSuffix(), stats, outputDir)
                    }
                }
            }
        }
